<script>
  ...
  /* IMPORTANT: Si NO usásemos $state, no se actualizaría */
  /* Sin embargo, un $state para algo como datos masivos y totalmente cambiantes puede ser demasiado, por lo que ponemos .raw para que solo esté se actualice cuando se iguale a otra cosa, no cuando cambie una propiedad del objeto/array. Esto es exactamente lo que haría Angular */
