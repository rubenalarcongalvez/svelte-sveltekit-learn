...
<!-- URGENT: Esto es muy útil para transacciones, cuando queremos que al ocurrir un evento de JS/TS, se vuelva a construir el elemento y por tanto se ejecute la transacción -->
{#key i}
